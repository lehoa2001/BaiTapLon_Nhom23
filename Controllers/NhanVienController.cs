...
namespace BaiTapLon_Nhom23.Controllers
{
    public class NhanVienController : Controller
    {
        ...
        {
            ViewData["MaChucVu"] = new SelectList(_context.Set<ChucVu>(), "MaChuVu", "MaChuVu");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("MaID,Ten,NgaySinh,QueQuan,SĐT,MaChucVu")] NhanVien nhanVien)
        {
            ...
            ViewData["MaChucVu"] = new SelectList(_context.Set<ChucVu>(), "MaChuVu", "MaChuVu", nhanVien.MaChucVu);
            return View(nhanVien);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaID,Ten,NgaySinh,QueQuan,SĐT,MaChucVu")] NhanVien nhanVien)
        {
            if (id != nhanVien.MaID)
            {
                return NotFound();
