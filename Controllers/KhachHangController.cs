...
namespace BaiTapLon_Nhom23.Controllers
{
    public class KhachHangController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IDKhachHang,TenKhachHang,DiaChi,SĐT")] KhachHang khachHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("IDKhachHang,TenKhachHang,DiaChi,SĐT")] KhachHang khachHang)
        {
